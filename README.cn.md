...
[![x-cmd/install — hygg Code Quality Monitoring Repo Card](https://repo.x-cmd.io/hygg.svg?lang=zh)](https://x-cmd.com/install/hygg)
...
- **上游仓库**: <https://github.com/kruserr/hygg>
- **官网**: <https://terminaltrove.com/hygg>
- **许可证**: AGPL-3.0
...
- **Star**: 355 · **Fork**: 17 · **开放 issue**: 12 · **贡献者**: 4
...
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/hygg.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260921.yml` · 2026-09-21T06:21:13Z._
